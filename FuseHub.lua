...
shared.LoaderTitle = "Subscribe Subscribe";
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=1371747897";
v24.Parent = v23;
...
v16.Home:AddButton({
    Title = "Youtube",
    Description = "Let's Hit 1000 Subs",
    Callback = function()
        setclipboard("https://www.youtube.com/@Jaiaca01");
    end
});
...
if Sea3 then
    ...
    local v495 = v16.Main:AddToggle("ToggleSpawnCake", {
        Title = "Auto Spawn Cake Commander",
        Description = "",
        Default = true
    });
...
local v66 = v16.Sea:AddToggle("ToggleTpAdvanced", {
    Title = "Tp to Advance Fruit Dealer",
    Description = "",
    Default = false
});
...
local v68 = v16.Sea:AddToggle("Togglelockmoon", {
    Title = "Look at the moon and use race",
    Description = "",
    Default = false
});
...
local v125 = v16.Fruit:AddToggle("TogglePermanentFruit", {
    Title = "Buy Selected Permanent Furit",
    Description = "",
    Default = false
});
...
local v56 = v16.Fruit:AddSection("Locate");
...
local v158 = v16.Sea:AddToggle("ToggleReceiveQuest", {
    Title = "Receive the Red Fire Quest",
    Description = "Turn it on once to receive one, turn it off and on again to receive another",
    Default = false
});
...
local v160 = v16.Sea:AddToggle("ToggleHydraTree", {
    Title = "Destroy the Tree on Hydra Island",
    Description = "",
    Default = false
});
...
local v166 = v16.Sea:AddParagraph({
    Title = "Complete Draco Stage V4 (Coming Soon)",
    Content = ""
});

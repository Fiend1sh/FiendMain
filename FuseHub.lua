...
local Window = Fluent:CreateWindow({Title = "Fuse Hub",SubTitle = "| https://www.youtube.com/@Jaiaca01",TabWidth = 155,Size = UDim2.fromOffset(555, 320),Acrylic = false,Theme = "AMETHYST",MinimizeKey = Enum.KeyCode.End})
local Tabs = {
